...
namespace CP380_PubsLab.Models
{
    public class PubsDbContext : DbContext
    {
        ...
        public DbSet<Jobs> Jobs { get; set; }           //Job table
    ...
    public class Employee
    {
        // TODO
        [Key]
        public string emp_id { get; set; } //Add emp_id, fname, and lname fields
        public string fname { get; set; }
        public string lname { get; set; }
        public Int16 job_id { get; set; } //Connect to Job table
        [ForeignKey("job_id")]
    ...
    public class Jobs
    {
        // TODO
        [Key]
        public Int16 job_id { get; set; } //Add job_id and job_desc in the Jobs class
